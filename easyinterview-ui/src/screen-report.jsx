...
const ReportEditorial = ({ T, lang, nav, r }) => {
  const D = window.EI_DATA;
  const L = lang === "en" ? {
    back: "Back to interview setup", session: "SESSION REPORT", round: "Round",
    ...
    openDrill: "Bring into next mock", addToMistakes: "Send to question review", addedToMistakes: "Added",
  } : {
    back: "返回面试前确认", session: "会话报告", round: "轮次",
    ...
    openDrill: "带入下场面试", addToMistakes: "写入题目回顾", addedToMistakes: "已加入",
  };
