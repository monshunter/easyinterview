# Materials Index: Full Funnel Real Provider Manual UAT
...
| 文件 | 角色 | 语言 | 主要用途 |
|------|------|------|----------|
| [`account.md`](./account.md) | UAT account | N/A | Mailpit magic-link 登录、cookie 检查与 cleanup 说明 |
...
| 漏斗步骤 | 用哪个材料 | 怎么用 |
|----------|------------|--------|
| 登录态 | `account.md` | 输入 synthetic 邮箱，打开 Mailpit 本地邮件，完成 magic-link 登录 |
...
- 自动化场景（`E2E.P0.098` / `E2E.P0.099`）使用各自的 fixture / seed，不消费本目录素材；本目录仅服务 `E2E.P0.100` 人工真实 provider UAT。
