...
| `/#route=welcome` 等 12 个退役 alias | welcome / growth / plan / mistakes / drill / followup / experiences / star / onboarding / debrief / debrief_full / profile |
| `/totally-unknown?foo=bar` | 未知 canonical path |
| `/voice?mode=voice` / `/debrief?...` / `/profile` | 退役 canonical path |
