...

{
  ...
  go test ./internal/resume -run 'Test(ListResumesDoesNotReuseFullDetailMappers|ListResumesMapsNullHeadlineAndUnreadableContent|ListResumesRejectsInvalidSourceType)' -count=1 -v
