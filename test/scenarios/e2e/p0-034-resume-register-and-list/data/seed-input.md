...
- Register scenarios:
  ...
  - `guided`: `guidedAnswers` contains structured answers and must not appear in scenario logs.
- Fixture scenarios:
  - `openapi/fixtures/Resumes/registerResume.json`: `default`, `paste-text`, `guided-answers`
