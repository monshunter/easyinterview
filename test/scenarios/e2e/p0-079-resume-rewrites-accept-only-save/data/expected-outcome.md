...
- Out-of-scope `resume-versions` and suggestion decision routes return 404 and are
...
- Out-of-scope Rewrites/Edit route params do not materialize removed frontend surfaces.
