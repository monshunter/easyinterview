...
mkdir -p "$OUTPUT_DIR"
{
  ...
  go test -v ./internal/store/debrief -run 'TestStoreGetSuggestionContext_TargetJobScoped|TestStoreGetSuggestionContext_LoadsResumeStructuredProfile|TestStoreGetSuggestionContext_CrossUserResumeNotFound' -count=1
  go test -v ./internal/debrief -run 'TestServiceSuggestQuestions_Happy|TestServiceSuggestQuestions_ResumeContextInPrompt|TestServiceSuggestQuestions_CrossUserTargetJob_403|TestServiceSuggestQuestions_F3ResolveFailed|TestServiceSuggestQuestions_A3Timeout|TestServiceSuggestQuestions_ParseFailed|TestAITaskRunsWritten|TestAuditEventsWritten|TestAuditEvents_NoRawText' -count=1
  go test -v ./internal/api/debriefs -run 'TestSuggestDebriefQuestions_MapsResumeIDToService|TestSuggestDebriefQuestions_CountBoundary|TestSuggestDebriefQuestions_Unauthenticated_401' -count=1
