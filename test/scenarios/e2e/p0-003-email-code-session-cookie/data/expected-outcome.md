...
- Dev mail sink retrieval provides the transient 6-digit challenge code while persisted delivery metadata remains redacted.
- `GET /auth/email/verify` mints `ei_session`; invalid and repeated code verification return B1 auth error envelope.
