...

{
  ...
  echo "resumes.display_name: queued null + LLM-derived ready-state name covered by parse/store/drainer gates"
  echo "upload parsed_text_snapshot: PDF/DOCX/Markdown/text readable extraction covered"
} | tee "$OUT/verify.log"
