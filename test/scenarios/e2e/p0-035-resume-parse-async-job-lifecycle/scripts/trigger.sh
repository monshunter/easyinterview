...

{
  ...
  go test ./internal/resume/store -run 'Test(CompleteParseSuccessWritesReadyStateProfileDisplayNameAndCompletedOutboxAtomically|CompleteParseFailureMarksFailedWithoutCompletedOutbox|ParseStatusTransition)' -count=1 -v
