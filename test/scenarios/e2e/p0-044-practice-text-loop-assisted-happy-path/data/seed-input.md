...
Route params: `sessionId / planId / targetJobId / jdId / resumeVersionId / roundId / mode=text / modality=text / practiceMode=assisted / practiceGoal=baseline / hintUsed=false / hintCount=0`.
