...
- 顶部 TopBar 渲染 ≥ 9 个控件 testid（company / title / question / timer / pause / mode-text / mode-voice / strict / role）
- 中部 grid 三栏渲染 SessionMap / QuestionCard / Transcript / InputBar / RightPanel
