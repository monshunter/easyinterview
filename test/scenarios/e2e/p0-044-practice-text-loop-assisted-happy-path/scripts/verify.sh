...
grep -Fq 'PRACTICE_P0044_SCREENSHOT_CAPTURE_PASS viewports=1440x900,390x844 states=immediate-pending,persisted-pending' "$LOG"
...
grep -Eq '(^|[[:space:]])6 passed([[:space:]]|$)' "$OUT/playwright.log"
...
echo 'PRACTICE_EVIDENCE_FINGERPRINT_PASS scenario=E2E.P0.044 screenshots=4 source=current'
