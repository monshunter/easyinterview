...
grep -Fq "E2E.P0.067 RUNNER pnpm vitest" "$LOG_FILE"
...
python3 "$REPO_ROOT/scripts/lint/frontend_debrief_legacy.py" --repo-root "$REPO_ROOT" --phase 8.10 >/dev/null
echo "E2E.P0.067 PASS"
