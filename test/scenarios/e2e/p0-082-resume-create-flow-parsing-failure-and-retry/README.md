# E2E.P0.082 Resume Create Flow Retired Parsing Surfaces Negative
...
- Create-flow source negative grep 扫描 retired parser / preview component names
- Locale and runtime source 扫描旧解析/预览确认文案
...
- 关联 test file 名称命中
- direct navigation / retired parser negative 关键 case 命中
