...
OUTPUT_DIR="$REPO_ROOT/.test-output/e2e/p0-096-jd-match-search-and-market-signals"
...
for marker in \
  ...
  "--- PASS: TestJDMatchFixtureParity/search" \
  "--- PASS: TestJDMatchFixtureParity/market_signals"; do
