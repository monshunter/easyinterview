...
grep -Fq 'PASS: TestCountExperienceCardsBySource' "$LOG_FILE"
grep -Fq 'PASS: TestGetCandidateProfileForUserSeededAndNil' "$LOG_FILE"
...
echo "method=cmd-api-http+internal-api" >> "$OUTPUT_DIR/setup.env"
