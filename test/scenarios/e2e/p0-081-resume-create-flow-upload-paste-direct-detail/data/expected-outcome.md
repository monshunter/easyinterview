...
- Sidebar: `resume-create-sidebar` does not render
- Parser/preview stages: `resume-parse-flow` and `resume-preview-confirm` do not render
...
- Source tree under `frontend/src/app/screens/resume-workshop/create/` contains zero out-of-scope module references
