...
export EI_AUTH_EMAIL_CODE_FRONTEND_ORIGIN="$FRONTEND_ORIGIN"
export EI_AUTH_EMAIL_CODE_API_BASE_URL="$API_BASE_URL"
export EI_AUTH_EMAIL_CODE_MAILPIT_BASE_URL="$MAILPIT_BASE_URL"
export EI_AUTH_EMAIL_CODE_EMAIL="$AUTH_EMAIL"
...
printf 'scenario=E2E.P0.101\nrun_id=%s\nmethod=playwright-host-run-email-code\ntrigger_at=%s\n' \
