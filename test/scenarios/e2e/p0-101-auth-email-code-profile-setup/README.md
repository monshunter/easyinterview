...
```bash
bash test/scenarios/e2e/p0-101-auth-email-code-profile-setup/scripts/setup.sh
bash test/scenarios/e2e/p0-101-auth-email-code-profile-setup/scripts/trigger.sh
bash test/scenarios/e2e/p0-101-auth-email-code-profile-setup/scripts/verify.sh
bash test/scenarios/e2e/p0-101-auth-email-code-profile-setup/scripts/cleanup.sh
```
...
- 未登录 TopBar 只有登录入口；`/auth/register` 或非当前 `auth_register` 不 materialize live page。
...
```text
.test-output/e2e/p0-101-auth-email-code-profile-setup/
```
