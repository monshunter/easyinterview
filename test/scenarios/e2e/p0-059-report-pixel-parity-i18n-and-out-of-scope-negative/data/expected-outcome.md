...
- Back reaches the same `/workspace?targetJobId=<uuid>` readonly detail without Parse animation; TopBar has no Reports entry and canonical Reports URL retains only `targetJobId`.
