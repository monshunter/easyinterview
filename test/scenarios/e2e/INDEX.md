...
| E2E.P0.099 | e2e-scenarios-p0 C-1, C-2, C-4, C-5, C-6 | `p0-099-full-funnel-fullstack-ui-journey/` | Real shared-env browser journey: Mailpit auth → resume/JD → continuous chat → conversation report + desktop/mobile screenshots | hybrid | Ready |
