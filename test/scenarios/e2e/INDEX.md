...
| E2E.P0.101 | backend-auth C-8; frontend-shell C-12; local-dev-stack C-10/C-15 | `p0-101-auth-email-code-login-register/` | Playwright host-run real-mode auth：注册邮箱唯一，同一邮箱后续登录；Mailpit 6 位验证码；重复注册不覆盖显示名 | automated | Ready |
