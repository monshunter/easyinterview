...
| E2E.P0.058 | frontend-report-dashboard C-1, C-9 | `p0-058-report-failure-and-missing-session/` | Backend repair/fail-closed markers + recoverable continue-check vs terminal back-only + API status/context truth | automated | Active refresh |
| E2E.P0.059 | frontend-report-dashboard C-5, C-6, C-8, C-10 | `p0-059-report-pixel-parity-i18n-and-out-of-scope-negative/` | Deterministic DOM/style/bbox/pixel diff, language split and stale-contract negatives | automated | Active refresh |
