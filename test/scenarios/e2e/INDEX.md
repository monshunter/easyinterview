...
| E2E.P0.101 | backend-auth C-9/C-13; frontend-shell C-8; local-dev-stack C-10/C-15 | `p0-101-auth-email-code-profile-setup/` | 真实邮箱登录、资料补全、账号主题单次保存/跨路由无重复读取与重登恢复 | automated | Ready |
