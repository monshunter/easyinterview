...
practice fixture 数据就绪：`getPracticeSession` 提供 `default / missing-session`；`appendSessionEvent` 提供 `default / ai-timeout / mismatch / hint-strict-conflict`。
...
- 409 strict-hint：strict mode + hint 触发 → InlineWarning 不重试
