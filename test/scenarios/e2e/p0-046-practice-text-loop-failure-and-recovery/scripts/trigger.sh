...
(
  ...
  go test ./internal/api/practice ./internal/practice ./internal/store/practice \
    -run '^(TestSendPracticeMessageMapsConflictAndIsolationErrors|TestSendPracticeMessageProviderFailureKeepsReservationUncommitted|TestSendPracticeMessagePersistsRetryableFailureWithDetachedBoundedContext|TestSendPracticeMessagePersistsTerminalFailure|TestSendPracticeMessageCommitFailurePersistsRetryableStateWithDetachedBoundedContext|TestSendPracticeMessageCommitFailureReturnsFinalizationError|TestSendPracticeMessageFailsClosedWithoutResumeContextAndSkipsAI|TestSendPracticeMessageExactReplayReturnsOriginalResultWithoutAICall|TestSendPracticeMessageMapsClientMismatchAndCrossUserAccess|TestSendPracticeMessagePendingSameIDDoesNotCallAI|TestSendPracticeMessageUsesConfiguredUTF8ByteLimitsBeforeAI|TestSQLRepositoryGetSessionReturnsUserReplyRecoveryStateOnly|TestSQLRepositoryReservePracticeMessageRetriesOnlyRetryableFailure|TestSQLRepositoryReservePracticeMessageRejectsPendingAndTerminalSameID|TestSQLRepositoryReservePracticeMessageRejectsNewMessageWhileReplyPending|TestSQLRepositoryReservePracticeMessageStartsGenerationOneWithExactLease|TestSQLRepositoryReservePracticeMessageRejectsAggregateLimitPlusOneBeforeInsert|TestSQLRepositoryCommitPracticeMessageInsertsReplyAndCompletesUserAtomically|TestSQLRepositoryCommitPracticeMessageRejectsAssistantAggregateLimitPlusOneBeforeInsert|TestSQLRepositoryFailPracticeMessageTransitionsPendingAtomically)$' \
    -count=1 -v
