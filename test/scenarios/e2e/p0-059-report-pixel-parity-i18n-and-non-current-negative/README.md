# E2E.P0.059 — Pixel parity + i18n + non-current negative gates
...
- `nonCurrentNegative.test.ts` — implementation code negative grep.
- `scripts/lint/frontend_report_dashboard_non_current.py` — repository-wide scoped grep.
