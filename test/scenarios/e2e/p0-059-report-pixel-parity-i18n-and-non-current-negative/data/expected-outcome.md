...
- Implementation files under report/ and generating/ contain none of the non-current vocabulary terms; the Python lint script and TypeScript negative-grep both pass.
