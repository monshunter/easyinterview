...
(
  ...
  pnpm --filter @easyinterview/frontend test \
    ...
    src/app/screens/report/__tests__/nonCurrentNegative.test.ts \
    src/app/screens/generating/__tests__/nonCurrentNegative.test.ts
  python3 scripts/lint/frontend_report_dashboard_non_current.py --repo-root . --phase E2E.P0.059
