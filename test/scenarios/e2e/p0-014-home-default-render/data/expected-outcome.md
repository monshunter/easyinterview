...
- Home hero title, separated JD paste/upload source panels, compact existing-resume dropdown row, create-resume CTA, submit row, and TopBar home highlight render in the fixture-backed UI.
