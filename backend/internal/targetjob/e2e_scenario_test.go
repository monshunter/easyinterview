...
func TestE2EP0010RawTextImportIdempotencyAndParseReady(t *testing.T) {
	...
	if store.captured.RawJDText != strings.TrimSpace(request.RawText) || store.captured.ResumeID != scenarioResumeID {
