...
func TestTaskRunWriterInsertsTypedColumns(t *testing.T) {
	...
	row := aiclient.AITaskRunRow{
		...
		Metadata:             aiclient.AuditMetadata{PromptHash: "prompt-hash", ResponseHash: "response-hash", PromptCharLength: 11, ResponseCharLength: 5, ProfileName: "practice.chat.default"},
		StartedAt:            now,
