...
eval-offline: ## F3 offline eval (NOT in make test): single-source drift gate + exact 32 cases + Promptfoo runner over recorded fixtures; EVAL_LIVE=1 opts into real provider/judge calls
