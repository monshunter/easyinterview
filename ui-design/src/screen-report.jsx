...
const ReportDashboard = ({ T, lang, nav, report, job, params }) => {
  ...
  const progress = window.eiResolvePracticeProgress(window.EI_DATA.jdSample.interviewRounds, job.practiceProgress);
  const canStartNextRound = progress.currentRound?.id === nextRound?.id;
