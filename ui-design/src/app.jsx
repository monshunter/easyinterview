        ...
        {themeMenuOpen && (
          <>
            ...
            <div style={{
              ...
              <button onClick={() => {
                if (!customActive) {
                  const seed = CUSTOM_ACCENT_SEEDS[theme] || CUSTOM_ACCENT_SEEDS.warm;
              ...
              {pickerOpen && (
                <AccentPicker
                  ...
                  lang={lang}
                  dark={dark}
                  value={customAccent || CUSTOM_ACCENT_SEEDS[theme] || CUSTOM_ACCENT_SEEDS.warm}
                  active={customActive}
        ...
        <div style={{ display: "flex", gap: 6 }}>
          ...
          <button onClick={() => {
            if (!tweaks.customAccent) {
              const seed = CUSTOM_ACCENT_SEEDS[tweaks.theme] || CUSTOM_ACCENT_SEEDS.warm;
