...
> 本索引按月份分组，时间倒序排列。每个 commit 独立一行。
...
|------|----------------|------|
| [2026-07-21](2026-07-21.md) | `fix(frontend): remove parsing wait back actions` | #fix #ui #test #docs #bdd #chrome |
...
| [2026-07-20](2026-07-20.md) | `fix(frontend): align report generating and back copy (BUG-0192)` | #fix #ui #i18n #test #docs #bdd #chrome |
| [2026-07-20](2026-07-20.md) | `fix(settings): anchor theme save action (BUG-0193)` | #fix #ui #test #docs #bdd #chrome |
...
| [2026-07-10](2026-07-10.md) | `refactor(repo): align active scope and remove stale assets` | #refactor #test #docs #ui #api |
| [2026-07-10](2026-07-10.md) | `refactor(repo): complete cross-layer tech debt pruning` | #refactor #test #docs #ui #api |
| [2026-07-10](2026-07-10.md) | `feat(practice): close real interview session flow` | #feat #api #ui #test #docs #bdd |
...
| 日期 | Commit Message | 标签 |
|------|----------------|------|
| [2026-06-30](2026-06-30.md) | `fix(frontend-home): require explicit resume selection (BUG-0130)` | #fix #ui #test #docs #bdd |
...
| [2026-06-14](2026-06-14.md) | `fix(resume): close detail rewrite review regressions (BUG-0123)` | #fix #ui #test #docs |
...
| [2026-06-14](2026-06-14.md) | `fix(test): close ux funnel refactor drift (BUG-0118)` | #fix #test #docs #ui #api |
| [2026-06-13](2026-06-13.md) | `feat(resume): implement d-20 resume flatten across contract backend frontend` | #feat #api #ui #i18n #test |
...
| [2026-06-13](2026-06-13.md) | `docs(resume): revise frontend specs for d-20 flatten` | #docs |
...
| 日期 | Commit Message | 标签 |
|------|----------------|------|
| [2026-05-28](2026-05-28.md) | `fix(frontend-shell): recover auth verify refresh failures (BUG-0117)` | #fix #ui #test #docs |
...
| [2026-05-18](2026-05-18.md) | `feat(frontend-shell): land url-addressable browser history routing` | #feat #ui #test #docs #bdd |
...
| [2026-05-12](2026-05-12.md) | `feat(openapi): add resume workshop contract coverage` | #feat #test #docs |
...
| [2026-05-10](2026-05-10.md) | `feat(jd_match): land search tab with saved searches, filters and auth gate` | #feat #ui #test |
...
| [2026-05-10](2026-05-10.md) | `feat(jobmatch): land fixtures and contract tests for jd-match operations` | #feat #test #docs |
...
| [2026-05-08](2026-05-08.md) | `docs(frontend-workspace-and-practice): seed workstream frontend owner subspec` | #docs |
...
| [2026-05-08](2026-05-08.md) | `docs(bugs): record BUG-0023 stale embedding test consumer` | #docs #fix |
| [2026-05-08](2026-05-08.md) | `fix(event-outbox): drop stale embedding job reference in jobs_test` | #fix #test |
...
| [2026-05-08](2026-05-08.md) | `feat(frontend-shell): implement language dropdown and locale catalog` | #feat #ui #test #docs |
| [2026-05-08](2026-05-08.md) | `docs(spec): sync spec versions and language dropdown terminology` | #docs |
| [2026-05-08](2026-05-08.md) | `fix(ai-provider): harden speech adapter contract gates` | #fix #test #docs |
...
| [2026-05-07](2026-05-07.md) | `feat(frontend-shell): auth pages and pending action` | #feat #test #ui #docs |
| [2026-05-07](2026-05-07.md) | `feat(frontend-shell): topbar and display controls` | #feat #test #ui #docs |
...
| [2026-05-06](2026-05-06.md) | `feat(backend-auth): runtime config resolver, privacy, and observability` | #feat #test #docs |
...
| [2026-05-06](2026-05-06.md) | `docs(frontend-shell): remediate app shell plan review gates` | #docs #ui |
| [2026-05-06](2026-05-06.md) | `fix(ai-provider): remediate tools streaming stt L2 findings` | #fix #test #docs |
...
| [2026-05-04](2026-05-04.md) | `fix(conventions): align codegen examples with current practice modes` | #fix #test |
...
| [2026-05-03](2026-05-03.md) | `fix(product-readiness): reconcile contract docs and ui scope` | #fix #docs #ui #test |
...
| [2026-05-02](2026-05-02.md) | `feat(ui): add assisted practice mode and pinned finish action` | #feat #ui |
...
| [2026-04-30](2026-04-30.md) | `feat(event-outbox): enforce event contract drift gate` | #feat #test #docs |
...
| [2026-04-29](2026-04-29.md) | `feat(openapi): add deleteMe fixture coverage` | #feat #test #docs |
| [2026-04-29](2026-04-29.md) | `feat(openapi): complete v1.8 contract remediation` | #feat #test #docs |
...
| [2026-04-27](2026-04-27.md) | `docs(shared-conventions): reconcile bootstrap assessment findings` | #docs |
