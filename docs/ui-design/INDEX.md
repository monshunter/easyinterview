...
| 文档 | 版本 | 状态 | 更新日期 | 说明 |
|------|------|------|----------|------|
| [目标总体架构](./ui-architecture.md) | 2.26 | active | 2026-07-12 | 三入口信息架构、TopBar、连续文本面试、disabled 电话入口、会话级报告与范围外 route 输入归一边界 |
...
| [模拟面试与报告目标模块](./module-practice-review.md) | 1.22 | active | 2026-07-12 | 全宽连续文本聊天、自然消息推进、disabled 电话入口、会话级报告和报告 CTA 闭环 |
| [报告仪表盘目标结构](./report-dashboard.md) | 1.15 | active | 2026-07-12 | session-scoped readiness、dimensions、evidence、next，删除题目回顾与逐题 replay |
