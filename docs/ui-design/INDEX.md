...
| [模拟面试与报告目标模块](./module-practice-review.md) | 1.20 | active | 2026-07-10 | 完整模拟面试、统一文本/电话模式外层骨架、电话模式只通过 practice 显式 phone 参数进入、无右侧边栏、无语音分析、无语音转文字、无跳过、面试官来自轮次规划、电话可切断/重新开始、out-of-scope 复盘边界和报告 CTA 直接进入面试 session 的仪表盘闭环 |
