...
| [报告仪表盘目标结构](./report-dashboard.md) | 1.33 | active | 2026-07-14 | target-scoped current/latest ReportsScreen、Workspace-detail Back、reportId-only frozen detail、honest wait 与 desktop+390 responsive contract |
