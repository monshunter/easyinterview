...
| [模拟面试与报告目标模块](./module-practice-review.md) | 1.31 | active | 2026-07-15 | 全宽连续文本聊天、安全 Markdown/GFM、持久回复状态，以及 report-owned 只读 transcript 的复用与实时控件负向边界 |
| [报告仪表盘目标结构](./report-dashboard.md) | 1.34 | active | 2026-07-15 | target-scoped current/latest ReportsScreen、reportId-only dashboard 与只读会话记录、父报告 Back、honest wait 和 desktop+390 parity |
