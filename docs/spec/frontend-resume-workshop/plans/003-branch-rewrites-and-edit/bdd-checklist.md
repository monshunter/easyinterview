...
- [ ] 创建场景目录 `test/scenarios/e2e/p0-084-resume-branch-flow-three-seed-strategies/`，含 `README.md`（§6 baseline + §7 离线限制 + §8 fixture-backed frontend 标注 + Phase 0 real-backend preflight evidence）+ `data/seed-input.md` + `data/expected-outcome.md`
...
- [ ] 准备 fixture variant：plan 001 `exportResumeVersion.json p0-501-not-available` + plan 003 BranchFlow / RewritesTab / EditTab 主路径 fixture；用户已登录 lang=zh-CN；TARGETED 版本 `v1`；记录 Phase 0 real-backend preflight evidence（export PDF 仍为 P0 501 stub）
