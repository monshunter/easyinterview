...
- [x] Owner behavior tests 覆盖 desktop 固定最大列宽/左对齐、mobile 单列/no-overflow、closed 摘要字段与 table/header/row 负向语义。（验证：CSS owner + list/fixture/StrictMode tests PASS；真实 no-overflow 留待 browser gate）
