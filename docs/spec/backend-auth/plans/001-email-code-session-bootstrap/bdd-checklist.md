...
- [x] 断言错误/隐私/非当前口径路径：邮件、URL、console、scenario evidence 不含非当前 URL callback、`/auth/verify?token=`、raw session cookie、`purpose=signup/login` request body、注册按钮、`auth_register` live page、`刘哲` / `Liu Zhe` / `liuzhe@example.com`
- [x] 执行并通过场景验证，记录验证证据
