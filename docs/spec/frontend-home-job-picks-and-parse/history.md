...
| 日期 | 版本 | 变更 | 关联计划 |
|------|------|------|----------|
| 2026-07-15 | 2.27 | 统一详情删除独立 launch/绑定简历 block，标题旁绑定简历只跳对应 Resume 详情，并将立即面试与面试报告合并为左对齐首行动作行。 | [001-home-jd-import-and-parse](./plans/001-home-jd-import-and-parse/plan.md) Phase 23 |
...
| 2026-07-07 | 2.7 | 对齐 current UI design document 与 formal frontend：`home-jd-source-controls`、`home-resume-select`、`home-recent-more`、Parse `resumeId` handoff 和 `autoStartPractice` handoff 均进入 owner gate。 | 001-home-jd-import-and-parse |
