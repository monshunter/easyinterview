...
| 2026-05-08 | 1.1 | 终稿候选修订：按 spec review 结论收敛 owner 范围为 `workspace / practice / generating`；补充 route 最小上下文矩阵、OpenAPI operation matrix、UI 设计文档 anchor 修正、current-scope negative gate 分类和 acceptance criteria 映射。 | 无计划目录 |
