...
| `listTargetJobs` | `openapi/fixtures/TargetJobs/listTargetJobs.json`: current variants | Workspace query-free list rail；same-key initial underlying count=1 | targetjob list handler/service/store | `target_jobs` + completion-ledger read projection | none | `E2E.P0.018`, `E2E.P0.098` |
| `getTargetJob` | `openapi/fixtures/TargetJobs/getTargetJob.json`: current variants | Workspace detail + start/display consumers；detail same-key initial count=1 | targetjob get handler/service/store | `target_jobs` + requirements/progress projection | none | `E2E.P0.018`, `E2E.P0.045`, `E2E.P0.098` |
...
| `getPracticeSession` | current fixtures unchanged | loader/rehydration + safe Markdown/GFM projection of raw persisted text | existing handler/service/repository | raw `practice_messages.text` and reply facts unchanged | none | `E2E.P0.044`, `E2E.P0.046` |
| `sendPracticeMessage` | current fixtures unchanged | send/retry raw text + Markdown/GFM view projection；retry exact original text/clientMessageId | existing handler/service/store | raw text/idempotency facts unchanged | `practice.session.chat` | `E2E.P0.044`, `E2E.P0.046` |
