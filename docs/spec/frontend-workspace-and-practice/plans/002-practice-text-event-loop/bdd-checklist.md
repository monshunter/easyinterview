...
- [x] P0.046 captures the generic terminal state at desktop/mobile and proves the only action enters exact `parse(targetJobId)` with no retry/workspace/planId/technical-text path.
