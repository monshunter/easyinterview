...
| 计划 | 文件 | 版本 | 状态 | 完成日期 |
|------|------|------|------|----------|
| [002-versions-tailor-runs-and-save-v1](./002-versions-tailor-runs-and-save-v1/plan.md) | [plan](./002-versions-tailor-runs-and-save-v1/plan.md) / [checklist](./002-versions-tailor-runs-and-save-v1/checklist.md) / [context](./002-versions-tailor-runs-and-save-v1/context.yaml) / [bdd-plan](./002-versions-tailor-runs-and-save-v1/bdd-plan.md) / [bdd-checklist](./002-versions-tailor-runs-and-save-v1/bdd-checklist.md) | 1.2 | completed | 2026-05-17 |
