...
| `getResumeSource` | current source fixtures | PDF page-stack source | backend-resume source handler | file object + object storage | none | 当前无真实 E2E owner；root `make test` + frontend PDF page-stack component tests |
