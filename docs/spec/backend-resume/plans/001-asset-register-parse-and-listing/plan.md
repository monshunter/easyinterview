...
- [backend-upload/001](../../../backend-upload/plans/001-file-objects-and-presign-baseline/plan.md) 是完成条件（createUploadPresign + Register internal API 可用）。截至 2026-05-12 backend-upload/001 Phase 5 收口，`createUploadPresign` handler、`RegisterFileObject` internal service 与 privacy delete baseline 已可用；backend-resume/001 可在本提交之后进入 `/implement`。
