...
## Phase 2: Plan tests
- [ ] Phase 2 plan validation/store/idempotency/isolation tests pass.

## Phase 3: Start tests
- [ ] Phase 3 opening/failure/repair/replay/privacy tests pass.

## Phase 4: Read tests
- [ ] Phase 4 ordered/empty/missing/cross-user/list tests pass.

## Phase 5: Gate set
- [ ] Phase 5 focused/full/codegen/migrate/docs/diff gates pass.
