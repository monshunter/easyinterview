...
| runtime boundary lint | removed practice terms, duplicate report handoff paths and compressed turn-status helpers stay out of runtime/scenario/generated surfaces | `python3 scripts/lint/backend_practice_out_of_scope.py --repo-root . --phase all`, `python3 -m pytest scripts/lint/backend_practice_out_of_scope_test.py -q` |
