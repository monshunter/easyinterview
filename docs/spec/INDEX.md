...
|---------|------|------|----------|-------|
| [engineering-roadmap](./engineering-roadmap/spec.md) | 1.2 | active | 2026-04-26 | [plans](./engineering-roadmap/plans/) |
...
| Subject | 版本 | 状态 | 更新日期 | Plans |
|---------|------|------|----------|-------|
| observability-stack（待 W1 spawn） | – | _pending_ | – | – |
| analytics-funnel（待 W2 spawn） | – | _pending_ | – | – |
| prompt-rubric-registry（待 W1 spawn） | – | _pending_ | – | – |
...
| Subject | 版本 | 状态 | 更新日期 | Plans |
|---------|------|------|----------|-------|
| backend-debrief（待 P1 spawn） | – | _pending_ | – | – |
