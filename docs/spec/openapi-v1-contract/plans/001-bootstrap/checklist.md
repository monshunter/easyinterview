...
- [x] 4.3 文档与 INDEX 同步：本 plan 自身 checklist 与 Phase 4 验证完成后将 plan/checklist Header 切到 completed，并用 `/sync-doc-index --fix-index` 同步 plans/INDEX.md；不联动 002 / 003 状态；`/sync-doc-index --check` 通过；不修改 engineering-roadmap/001 已完成的 roadmap checklist
