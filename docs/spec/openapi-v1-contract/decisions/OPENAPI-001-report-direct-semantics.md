...
- [openapi-v1-contract spec](../spec.md) D-32 / §4.4
...
| Review | product owner confirmed 方案 A on 2026-07-12 and its 200/24/64 + repair-margin 18/52 boundary on 2026-07-13 |
| 实施分支 | `fix/report-semantic-grounding-0712` |
