...
- `002-fixtures-and-mock-source`：每个 operationId 一份 fixtures + `prototype-baseline` 同步工具；Phase 12 删除旧 session-list fixture 并补齐 report conversation fixture；E1 接入。
