...
| Review | `FeedbackReport`、`DimensionAssessment`、`ReportHighlight`、`ReportIssue`、`ReportNextAction`、`PaginatedFeedbackReport` | 报告前台只展示准备度、能力维度、会话证据和下一步；不输出 question/turn review |
