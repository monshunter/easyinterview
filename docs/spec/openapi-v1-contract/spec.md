...
> Practice sessions listing (#21) 保留为核心 practice recovery / session list contract；最初由 `frontend-debrief/001` 引入，D-22 后不再承担 debrief picker 语义。
