...
- **技术真理源**：`easyinterview-tech-docs/00`–`06` 提供历史技术输入；当前可执行契约以 Layer B 已编码 truth source 为准：B2 OpenAPI 为 34 endpoint / 12 tag，B3 internal event 为 16 个，B4 baseline 为 26 张当前应用表 + 3 张 auth 支撑表 + 2 张迁移元数据表。
