...
- [F2 analytics-funnel](../../../engineering-roadmap/spec.md#56-layer-f--quality-横切4-份)：F2 PostHog 产品分析事件名严禁与本 plan 16 个 internal eventName 重名；命名空间分离由 C-10 守住。
