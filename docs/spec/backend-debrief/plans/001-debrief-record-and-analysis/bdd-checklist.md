...
- [x] 063.B 编写 fixtures：以 `data/seed-input.md` 和 service/API tests 固化 target_job + valid / timeout / invalid JSON
- [x] 063.C 编写 setup.sh：初始化 scenario output 与 setup marker
- [x] 063.D 编写 trigger.sh：执行 suggestDebriefQuestions service/API tests
- [x] 063.E 编写 verify.sh：assert success/failure/count-boundary tests 与 PASS marker
