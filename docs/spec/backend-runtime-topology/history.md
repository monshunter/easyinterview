...
| 日期 | 版本 | 变更 | 关联计划 |
|------|------|------|----------|
| 2026-07-10 | 1.8 | 将 runtime topology 负向 gate 与 owner handoff 术语统一为 out-of-scope；运行拓扑行为不变。 | 001-worker-consolidation |
...
| 2026-05-06 | 1.1 | L2 remediation：新增 `make lint-runtime-topology` 负向 gate，覆盖 active code/doc handoff 中 out-of-scope standalone worker process 口径回流。 | 001-worker-consolidation |
