...
| 日期 | 版本 | 变更 | 关联计划 |
|------|------|------|----------|
| 2026-05-22 | 1.2 | Repo lint follow-up：将 active spec 目标中的旧 standalone worker wording 改为当前 backend in-process runtime / 后台执行进程口径，保持 `runtime_topology` gate 通过。 | 001-internal-job-outbox-runner |
