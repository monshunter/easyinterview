...
- [x] `E2E.P0.055` privacy, cross-user, and current-scope boundary path is covered by `TestE2EP0055ReportPrivacyAndOutOfScope`.
  <!-- verified: 2026-05-16 method=go-http-scenario evidence="cd backend && go test ./cmd/api -run TestE2EP0055ReportPrivacyAndOutOfScope -count=1 PASS." -->
