...
| 日期 | 版本 | 变更 | 关联计划 |
|------|------|------|----------|
| 2026-06-29 | 1.1 | product-scope D-22 后同步 downstream 边界：真实面试复盘已退役，backend-review 不再声明 Debrief downstream owner；runner job_type 描述移除 debrief_generate。 | product-scope/001-core-loop-module-pruning |
