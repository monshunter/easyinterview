...
| 2026-05-07 | 1.5 | 派生 D2 视觉系统接入计划；新增 §6 C-8 视觉接入验收，将 `ui-design/` 真理源、`DESIGN.md` 只读参考边界、4 主题 × 2 模式 wiring、开源字体与 D1 regression 固化为视觉接入门禁。 | 002-app-shell-visual-system |
