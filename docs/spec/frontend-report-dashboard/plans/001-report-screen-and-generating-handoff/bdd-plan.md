...
| C-13（UI stale-contract negative） | `E2E.P0.059` 子断言（scoped non-current grep） |
...
| D-12（non-current 术语） | `E2E.P0.059` 子断言（scoped non-current grep） |
