...
| REAL.ENV.PHONE.SCREENSHOT | final acceptance | Phase 6 | 真实本地环境打开电话模式，截图证明 phone UI、字幕、切断/重开存在，右栏/语音分析/手动转写 fallback 不存在 | `.test-output/` browser screenshot artifacts |
