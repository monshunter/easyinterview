...
| ID | 标题 | 严重度 | 状态 | 发现日期 | 关联 Commit |
|----|------|--------|------|----------|-------------|
| [BUG-0110](./BUG-0110.md) | real-provider UAT bypassed the standard scenario runner | medium | resolved | 2026-05-27 | `fix(test): unify real-provider hybrid scenario (BUG-0110)` |
