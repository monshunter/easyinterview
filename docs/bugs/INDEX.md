...
| ID | 标题 | 严重度 | 状态 | 发现日期 | 关联 Commit |
|----|------|--------|------|----------|-------------|
| [BUG-0172](./BUG-0172.md) | malformed report conversation ID reached the UUID database query | medium | resolved | 2026-07-15 | `feat(report): implement readonly conversation record (BUG-0172, BUG-0173)` |
...
| ID | 标题 | 严重度 | 状态 | 发现日期 | 关联 Commit |
|----|------|--------|------|----------|-------------|
| [BUG-0173](./BUG-0173.md) | evidence privacy gate rejected benign PNG metadata | medium | resolved | 2026-07-15 | `feat(report): implement readonly conversation record (BUG-0172, BUG-0173)` |
