...
| ID | 标题 | 严重度 | 状态 | 发现日期 | 关联 Commit |
|----|------|--------|------|----------|-------------|
| [BUG-0192](./BUG-0192.md) | core workflow pages drifted from the approved UI references | low | resolved | 2026-07-19 | `fix(report): rebuild dashboard target composition (BUG-0192)` |
