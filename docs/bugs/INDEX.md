...
| [BUG-0192](./BUG-0192.md) | core workflow pages drifted from the approved UI references | low | resolved | 2026-07-19 | `fix(frontend): unify framed action button radius (BUG-0192)` |
