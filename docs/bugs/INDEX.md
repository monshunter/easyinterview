...
| ID | 标题 | 严重度 | 状态 | 发现日期 | 关联 Commit |
|----|------|--------|------|----------|-------------|
| [BUG-0130](./BUG-0130.md) | parse launch allowed practice planning without a bound resume | high | resolved | 2026-06-30 | `fix(frontend-home): require resume binding before practice (BUG-0130)` |
