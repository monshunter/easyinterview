...
| `make validate-fixtures` | Schema-validate every `openapi/fixtures/<tag>/<operationId>.json` against `openapi.yaml`; enforce AI-schema provenance, privacy / UUIDv7 scans, and 34-operation coverage. Owner B2 002. |
...
PracticeSessions, Reports, ResumeTailor, Debriefs, Jobs, Privacy. The 34
