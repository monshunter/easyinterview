...
export const en: LocaleMessages = {
  ...
  "settings.subtitle": "Your account details and privacy controls, in one place.",
  ...
  "settings.exportReason": "Data export is not available in this development version.",
  "settings.deleteTitle": "Delete account",
  "settings.deleteDescription": "Permanently remove your account and begin deleting its data.",
  "settings.deleteAction": "Delete account",
  "settings.deleteEyebrow": "DESTRUCTIVE ACTION",
  "settings.deleteQuestion": "Delete account?",
  "settings.deleteConfirmDescription":
    "This starts permanent account deletion. You cannot undo this action.",
  "settings.cancel": "Cancel",
  "settings.deleteConfirm": "Confirm deletion",
  "settings.deletePending": "Deleting…",
  "settings.deleteError": "Account deletion could not be started. Please try again.",
  ...
  "parse.resumeBinding": "Bound resume",
  ...
  "report.conversation.subtitle": "A read-only record of the completed interview conversation.",
  "report.conversation.transcriptLabel": "Interview conversation record",
  "report.conversation.empty.eyebrow": "NO MESSAGES",
  "report.conversation.empty.body": "This verified interview record does not contain any messages.",
  "report.conversation.userBadge": "ME",
  "report.conversation.assistant": "Interviewer",
  "report.conversation.user": "You",
  "report.conversation.loading.eyebrow": "LOADING RECORD",
  "report.conversation.loading.title": "Opening this interview record…",
  "report.conversation.loading.description": "The conversation will appear only after its report context is verified.",
  "report.conversation.loading.back": "Back to interviews",
  "report.conversation.unavailable.eyebrow": "RECORD UNAVAILABLE",
  "report.conversation.unavailable.title": "This interview record cannot be opened.",
  "report.conversation.unavailable.description": "Return to your interviews and open another verified report.",
