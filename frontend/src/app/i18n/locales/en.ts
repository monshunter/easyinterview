...
export const en: LocaleMessages = {
  ...
  "generating.header.title": "Reading the full conversation. Evidence first.",
  ...
  "generating.phase.1": "Organizing conversation context",
  "generating.phase.1.hint": "reading the complete conversation in order",
  "generating.phase.2": "Extracting key evidence",
  ...
  "generating.phase.4": "Clustering capability signals",
  "generating.phase.4.hint": "forming conversation-level strengths and risks",
  ...
  "generating.evidence.line.1": "\"LCP from 3.2s to 1.4s\" → quantified outcome · high confidence",
  "generating.evidence.line.2":
    "\"We — actually I — drove the migration\" → self-correction observed",
  "generating.evidence.line.3":
    "\"they just agreed\" → conflict resolution lacks depth · flag",
  "generating.evidence.line.4":
    "assessing evidence density and communication quality across the conversation",
