...
/**
 * Workspace insight card — renders getTargetJob summary fields only.
 * The action stays on workspace with safe params.
 */
export const WorkspaceInsightCard: FC<WorkspaceInsightCardProps> = ({
  companyName,
  locationText,
  sourceType,
  summary,
  ...
  return (
    <div
      data-testid="workspace-insight-summary"
      style={{
    ...
    >
      ...
      <button
        data-testid="workspace-insight-open"
        onClick={() =>
          navigate({
            name: "workspace",
