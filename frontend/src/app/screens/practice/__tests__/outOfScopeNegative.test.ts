...
describe("practice out-of-scope negative gates (Phase 5)", () => {
  ...
  it("keeps prototype data, out-of-scope voice semantics, and route names out of runtime code", () => {
    const text = runtimeText();
    expect(text).not.toMatch(
      /from\s+["'][^"']*ui-design\/src\/(?:data|screen-practice)|window\.EI_DATA/,
    );
