/**
 * Phase 5.7 — Report module legacy negative gate.
 *
 * Asserts:
 *   - Implementation files under frontend/src/app/screens/report/ do NOT
 *     import ui-design/src/data*, window.EI_DATA, prototype helpers, voice
 *     surface components, or retired report tab vocabulary.
 *   - Implementation does not call practice operations or voice / company-intel
 *     operations.
...
describe("frontend-report-dashboard/001 report module negative grep", () => {
  it("contains no retired report-layout / readiness / mistakes / voice / company-intel / data prototype imports", () => {
