/**
 * Phase 5.7 — Report module non-current negative gate.
 *
 * Asserts:
 ...
 *     surface components, or non-current report tab vocabulary.
...
describe("frontend-report-dashboard/001 report module negative grep", () => {
  it("contains no non-current report-layout / readiness / mistakes / voice / insight API / data prototype imports", () => {
