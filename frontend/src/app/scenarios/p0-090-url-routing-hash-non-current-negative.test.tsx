...
/**
 * E2E.P0.090 — Hash compatibility + non-current route negative regression.
 *
 ...
 *   - Non-current aliases (`welcome`, `growth`, `plan`, `mistakes`, `drill`,
...
describe("E2E.P0.090 hash compatibility + non-current route negative regression", () => {
  ...
  it("non-current aliases via hash all normalize to retained routes (welcome / growth / plan / mistakes / drill / followup / experiences / star / onboarding / debrief / debrief_full / profile)", () => {
  ...
  it("ROUTE_TO_PATH must not include non-current paths and must NOT have standalone /voice", () => {
  ...
  it("formatRouteUrl maps every non-current alias to a retained canonical path", () => {
