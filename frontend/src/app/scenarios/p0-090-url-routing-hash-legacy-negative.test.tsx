...
describe("E2E.P0.090 hash compatibility + legacy route negative regression", () => {
  ...
  it("ROUTE_TO_PATH must not include retired paths and must NOT have standalone /voice", () => {
