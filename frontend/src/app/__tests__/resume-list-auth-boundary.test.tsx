...
describe("resume flat list and auth boundary", () => {
  ...
  it("opening a flat card navigates to that resume's read-only detail with only resumeId", async () => {
    ...
    console.log(
      "resume summary-only list/detail transport PASS summaryFields=9 listResumes=1 getResumeBeforeOpen=0 getResumeAfterOpen=1",
    );
  });
