...
export const JOB_TYPE_DEBRIEF_GENERATE = "debrief_generate" as const;
export const JOB_TYPE_SOURCE_REFRESH = "source_refresh" as const;
export const JOB_TYPE_EMBEDDING_UPSERT = "embedding_upsert" as const;
...
export const ASYNQ_TASK_DEBRIEF_GENERATE = "debrief.generate" as const;
export const ASYNQ_TASK_SOURCE_REFRESH = "source.refresh" as const;
export const ASYNQ_TASK_EMBEDDING_UPSERT = "embedding.upsert" as const;
