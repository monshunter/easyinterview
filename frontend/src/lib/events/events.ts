...
import type { InterviewerRole, MistakeStatus, PracticeGoal, PracticeMode, PrivacyRequestStatus, PrivacyRequestType, ReadinessTier, ReportStatus, TargetJobParseStatus } from '../conventions';
...
export const EVENT_NAME_MISTAKE_CREATED = "mistake.created" as const;
export const EVENT_NAME_MISTAKE_STATUS_CHANGED = "mistake.status.changed" as const;
...
export interface MistakeCreatedPayload {
...
export interface MistakeStatusChangedPayload {
  fromStatus: MistakeStatus;
  mistakeId: string;
  targetJobId: string;
...
export interface EventNameToPayload {
  ...
  "mistake.created": MistakeCreatedPayload;
  "mistake.status.changed": MistakeStatusChangedPayload;
