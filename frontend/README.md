...
| Settings / Placeholder / D2-D6 业务 | `ei-screen-shell` / `ei-screen-card` / `ei-skeleton-{stripe,line}` / `ei-screen-card-grid` | [`src/app/screens/screens.css`](./src/app/screens/screens.css) |
