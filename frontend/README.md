...
| owner | 写入范围 |
|-------|----------|
| `frontend-home-job-picks-and-parse` | `src/app/screens/home/HomeScreen.tsx` / `src/app/screens/parse/ParseScreen.tsx`（non-current job-recommendation inputs 归一回 `home`） |
